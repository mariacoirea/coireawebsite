...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen flex items-center justify-center relative overflow-hidden py-16 sm:py-20"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        <header>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-semibold text-primary mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight">
        ...
        <div className="max-w-4xl mx-auto mb-8 sm:mb-12">
          <p className="text-base sm:text-lg md:text-xl text-primary/70 font-body leading-relaxed mb-6 sm:mb-8 px-2">
          ...
          <p className="text-base sm:text-lg text-primary/60 font-body px-2">
        ...
        <div className="flex justify-center items-center mb-12 sm:mb-16">
          <Link to="/journey" aria-label="Begin your organizational transformation journey">
            <Button variant="default" size="xl" className="group bg-[#4A7C7A]/90 hover:bg-[#4A7C7A] text-white border-none rounded-full px-6 sm:px-8 py-3 sm:py-4 transition-all duration-300 shadow-lg text-sm sm:text-base">
              Begin Your Journey

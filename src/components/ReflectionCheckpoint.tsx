        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="space-y-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6 rounded-xl bg-copper/5 backdrop-blur-sm border border-copper/20">
                <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                  <span className="font-semibold text-copper">Companies with strong culture see 72% higher engagement and 40% lower turnover</span>, proving that intentional culture transformation delivers measurable results.

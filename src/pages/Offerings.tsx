...
import { Brain, Leaf, Target, Heart, Compass, ArrowRight, Building, Users, Lightbulb, Star } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        {/* Transformational Offerings Section - Replicated from HOME */}
        <section className="py-24" style={{ backgroundColor: '#F6F0E9' }}>

                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden sticky top-8">
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Regenerative Consultancy</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <nav className="p-4">
                    <div className="space-y-2">
                      {[
                        ...
                        { 
                          icon: <div className="w-4 h-4 bg-muted-foreground/20 rounded flex items-center justify-center"><div className="w-2 h-2 bg-muted-foreground rounded"></div></div>, 
                          label: "KPI Tracking" 
                        },
                        { 
                          icon: <div className="w-4 h-4 bg-muted-foreground/20 rounded flex items-center justify-center"><div className="w-2 h-2 bg-muted-foreground rounded"></div></div>, 
                        ...
                        <div key={index} className={`flex items-center gap-3 px-3 py-2.5 rounded-lg cursor-pointer transition-colors ${
                          item.active 
                  ...
                  <div className="p-4 border-t border-gray-200">
                    <div className="flex items-center gap-3 px-3 py-2">
                      ...
                      <span className="text-sm font-medium text-muted-foreground">Platform v1.0</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="grid lg:grid-cols-3 gap-12 items-start">
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
                      ...
                      <div className="bg-gray-50 p-6 border-b border-gray-200">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-muted-foreground">Elevating business through human-centered transformation</p>
                          </div>
                          <div className="flex items-center gap-4">
                            <input 
                              type="text" 
                              placeholder="Search insights..." 
                              className="bg-white border border-gray-200 rounded-lg px-4 py-2 text-sm w-48"
                            />
                      ...
                      <div className="p-8">
                        <div className="mb-8">
                          ...
                          <p className="text-muted-foreground mb-6">Real-time pulse of organizational health</p>
                        ...
                        <div className="grid grid-cols-5 gap-6">
                          {[
                            { name: "Purpose", score: 46, color: "#D2691E", description: "Clarity and storytelling coherence" },
                            { name: "Leadership", score: 52, color: "#8FBC8F", description: "Presence and compassionate feedback" },
                            { name: "Collaboration", score: 50, color: "#CD853F", description: "Energy, trust, and communication flow" },
                            { name: "Culture", score: 54, color: "#2F4F4F", description: "Values alignment and team energy" },
                            { name: "Well-Being", score: 61, color: "#5F8A5F", description: "Energy levels and mindfulness adoption" }
                          ].map((pillar, index) => (
                            <div key={index} className="text-center">
                              ...
                              <div className="text-xs text-muted-foreground leading-tight">{pillar.description}</div>
                            </div>
                          ))}
                        </div>
                      </div>
                  ...
                  <div className="lg:col-span-1">
                    ...
                    <div className="space-y-4 text-base text-muted-foreground font-body leading-relaxed">
                      ...
                      <div className="bg-primary/5 border-l-4 border-copper p-4 rounded-r-lg">

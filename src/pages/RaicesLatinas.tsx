  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-24 bg-[hsl(var(--raices-sage-green))]/30">
          <div className="container mx-auto px-4">
        ...
        <section className="py-24 bg-[hsl(var(--raices-sage-green))]/25">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
        ...
        <section className="py-24 bg-[hsl(var(--raices-sage-green))]/20">
          <div className="container mx-auto px-4">
